...
template <> SEXP wrap(const odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24_Strategy<double>, plant::TF24_Environment> >&);
template <> odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24_Strategy<double>, plant::TF24_Environment> > as(SEXP);

template <> SEXP wrap(const odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24f_Strategy<double>, plant::TF24_Environment> >&);
template <> odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24f_Strategy<double>, plant::TF24_Environment> > as(SEXP);
...
template <> SEXP wrap(const plant::Individual<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Individual<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::Individual<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Individual<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::tools::IndividualRunner<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::tools::IndividualRunner<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::tools::IndividualRunner<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::tools::IndividualRunner<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::Parameters<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Parameters<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::Parameters<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Parameters<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::Node<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Node<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::Node<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Node<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::Species<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Species<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::Species<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Species<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::Patch<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Patch<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::Patch<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::Patch<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::SCM<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::SCM<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::SCM<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::SCM<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::StochasticSpecies<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::StochasticSpecies<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::StochasticSpecies<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::StochasticSpecies<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::StochasticPatch<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::StochasticPatch<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::StochasticPatch<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::StochasticPatch<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::StochasticPatchRunner<plant::TF24_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::StochasticPatchRunner<plant::TF24_Strategy<double> ,plant::TF24_Environment> as(SEXP);

template <> SEXP wrap(const plant::StochasticPatchRunner<plant::TF24f_Strategy<double> ,plant::TF24_Environment>&);
template <> plant::StochasticPatchRunner<plant::TF24f_Strategy<double> ,plant::TF24_Environment> as(SEXP);
